# Physical
@with_parameters(BW, m, Γ; support::Tuple{Float64,Float64}, begin
    NumericallyIntegrable(e->1/abs2(m^2-e^2 - 1im*m*Γ), _.support)
end)

@with_parameters(Braaten, γre, γim; support::Tuple{Float64,Float64}, begin
...
@with_parameters(CBpSECH, σ1, c0, c1, c2, n, s, fr1, w; support::Tuple{Float64,Float64}, begin
    σ2 = s * σ1
...
## 1st order Chebyshev
@with_parameters(Pol1, c1C; support::Tuple{Float64,Float64}, begin
    Chebyshev([1, c1C], _.support[1], _.support[2])
end)


## 2nd order Chebyshev
@with_parameters(Pol2, c1C, c2C; support::Tuple{Float64,Float64}, begin
